...
log=$results/n5_discovery_causal_v2.log
status=$results/n5_discovery_causal_v2.exit
...
if /root/miniconda3/bin/python -B 45_n5_causal_patch.py \
    ...
    --recon "$results/n5_discovery_recon_vectors_v2.npz" \
    ...
    --split discovery \
    --checkpoint "$results/n5_discovery_causal_checkpoint_v2.jsonl" \
    --out "$results/n5_discovery_causal_v2.json" \
    --layer-index 32 \
    --horizon 16 \
    --dtype bfloat16 \
