#!/usr/bin/env python3
"""Generate and freeze the C1-confirmatory synthetic prompt cohort.
...
3. Every string is an English user request, not an answer. Aim for 95-125
   words and never use fewer than 80 or more than 170 words.
